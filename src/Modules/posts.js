export const posts = [
  {
    ...
    loader: () => import('../Routes/GettingValueFromE2ETests.svelte'),
    external: '',
  },
  {
    ...
    loader: () => import('../Routes/CloudinarySupport.svelte'),
    external: '',
  },
  {
    ...
    loader: () => import('../Routes/WritingCodeReviewFeedback.svelte'),
    external:
  ...
  },
  {
    ...
    loader: () => import('../Routes/CodeSplittingInSvelte.svelte'),
    external:
  ...
  },
  {
    ...
    loader: () => import('../Routes/AddingMarkdownToSvelte.svelte'),
    external:
  ...
  },
  {
    ...
    loader: () => import('../Routes/ThemePickerDemo.svelte'),
    external:
  ...
  },
  {
    ...
    loader: () => import('../Routes/ThreeTipsReview.svelte'),
    external:
  ...
  },
  {
    ...
    loader: () => import('../Routes/PolaroidDemo.svelte'),
  },
  {
    title: 'Reviewing code like a junior engineer',
    date: '11/05/2020',
    path: '/code-review/like-a-junior',
    loader: () => import('../Routes/ReviewingCodeLikeAJunior.svelte'),
  },
]
